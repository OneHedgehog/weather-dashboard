...
export class ForecastComponent implements OnInit, OnChanges {
  ...
  public displayedColumns: string[] = [
    FORECAST_COLUMN_DEFS.DATE, FORECAST_COLUMN_DEFS.MIN, FORECAST_COLUMN_DEFS.MAX, FORECAST_COLUMN_DEFS.DAY, FORECAST_COLUMN_DEFS.NIGHT, FORECAST_COLUMN_DEFS.TIME_FORECAST
  ];
